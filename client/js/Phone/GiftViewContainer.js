...
define([winSize+'/MessageListContainer',
    ...
    function(MessageListContainer,
             ...
             SelectContainer,
             TaskViewContainer){
        var GiftViewContainer = function(props)
        {
            GiftViewContainer.superClass.constructor.call(this,props);
            this.init();
        };

        Q.inherit(GiftViewContainer, Q.DisplayObjectContainer);

        GiftViewContainer.prototype.init = function(){
            this.width = 290;
            this.height = 355;
			this.x=22;
			this.y=95;
		...
		GiftViewContainer.prototype.showInfos = function(mailinfo){
		...
		GiftViewContainer.prototype.GetMailTitle = function(){
			var text = this.mailinfo.title;
			var width = 265;
			var height = 35;
			var px = 0;
			var py = 0;
		...
		GiftViewContainer.prototype.GetMailSender = function(){
			var text = this.mailinfo.sender;
			var width = 265;
			var height = 35;
			var px = 0;
			var py = 0;
		...
		GiftViewContainer.prototype.GetMailContent = function(){
			var value = this.mailinfo.content;
			var width = 265;
			var height = 175;
			var px = 0;
			var py = 0;
		...
		//回复
		GiftViewContainer.prototype.getResponseBtn = function(){
			var self = this;
		...
		//删除
		GiftViewContainer.prototype.getDeleteBtn = function(){
			var self = this;
		...
		GiftViewContainer.prototype.getLeagueBottomBtn = function(id,callback){
			var iconWidth = 110;
			var iconHeight = 50;
			var iconpMargin = 10;
