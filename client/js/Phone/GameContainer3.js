...
define(['jquery','../TilesMap/mapWorker','TilesMap/MapGenerater','Worker'],
    function($,mapWorker,mapGenerater,Worker,DragController){
        ...
        GameContainer.prototype.init = function(){
            ...
            this.addChildAt(this.GetBgLeft(),7);

            this.addChildAt(this.GetBgRight0(),0);
            this.addChildAt(this.GetBgRight1(),1);
            this.addChildAt(this.GetBgRight2(),2);
            this.addChildAt(this.GetBgRight3(),3);
            this.addChildAt(this.GetBgRight4(),4);
            this.addChildAt(this.GetBgRight5(),5);

            this.bgright = this.GetBgRight();//底图
            this.addChildAt(this.bgright,6);
		...
		GameContainer.prototype. reflashUI = function(index){
			var self = this;
            console.log("curChild:"+self.curChildren);
			//self.removeChildAt(0);
			switch(index){
				case 0:
                    self.swapChildrenAt(this.curChildren, 6);
                    self.swapChildrenAt(0, 6);
                    this.curChildren = 0;
				break;
				case 1:
                    self.swapChildrenAt(this.curChildren, 6);
                    self.swapChildrenAt(1, 6);
                    this.curChildren = 1;
				break;
				case 2:
                    self.swapChildrenAt(this.curChildren, 6);
                    self.swapChildrenAt(2, 6);
                    this.curChildren = 2;
				break;
                case 3:
                    self.swapChildrenAt(this.curChildren, 6);
                    self.swapChildrenAt(3, 6);
                    this.curChildren = 3;
                break;
                case 4:
                    self.swapChildrenAt(this.curChildren, 6);
                    self.swapChildrenAt(4, 6);
                    this.curChildren = 4;
                break;
                case 5:
                    self.swapChildrenAt(this.curChildren, 6);
                    self.swapChildrenAt(5, 6);
                    this.curChildren = 5;
                break;
        ...
        GameContainer.prototype.DrawMap = function(){
           ...
           // else Sockets.send_ReqWorkerAll(userid);
            ...
            this.addChildAt(this.HouseBgView,2);
        };
