 ...
 */
define(function(){
    var ShowMsg = function(props,text)
    {
        ShowMsg.superClass.constructor.call(this,props);
        this.init(text);
    };

    Q.inherit(ShowMsg, Q.DisplayObjectContainer);

    ShowMsg.prototype.init = function(text){
        this.width = 622;
        this.height = 344;
    ...
    ShowMsg.prototype.getDesText = function(text){
        var num = 10;
        return this.getText(text);
    };

    ShowMsg.prototype.getOkBtn = function(){
    ...
    ShowMsg.prototype.getBtn = function(id){
        var width = 209;
        var height = 58;
    ...
    ShowMsg.prototype.getText = function(text){
    ...
    ShowMsg.prototype.getBg = function(){
