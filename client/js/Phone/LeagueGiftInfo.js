...
define(['jquery'],function($){
    var LeagueGiftInfo = function(props,Message)
    {
        LeagueGiftInfo.superClass.constructor.call(this, props);
        this.init(Message);
    };

    Q.inherit(LeagueGiftInfo, Q.DisplayObjectContainer);

    LeagueGiftInfo.prototype.init = function(Message){
	...
	LeagueGiftInfo.prototype.getLeagueItemBtn = function(){
		var self = this;
		return this.getItemBgBtn(function(){
			...
			Views.MainView.showGiftListViewContainer(self.Message);
		});
	};

	LeagueGiftInfo.prototype.getItemBgBtn = function(callback){
		//加载一个背景透明的图片
		var self = this;
        var btnWidth = 265;
        var btnHeight = 35;
	...
	LeagueGiftInfo.prototype.getInfo = function(){
