...
define(['jquery'],function($){
    var LeagueInfo = function(props,Message)
    {
    ...
    LeagueInfo.prototype.init = function(Message){
	...
	LeagueInfo.prototype.getLeagueItemBtn = function(){
		var self = this;
	...
	LeagueInfo.prototype.getItemBgBtn = function(callback){
		//加载一个背景透明的图片
		var self = this;
        var btnWidth = 265;
        var btnHeight = 35;
