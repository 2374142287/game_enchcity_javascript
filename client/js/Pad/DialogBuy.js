 ...
 */
define(function(){
    var DialogBuy = function(props)
    {
        DialogBuy.superClass.constructor.call(this,props);
        this.init();
    };

    Q.inherit(DialogBuy, Q.DisplayObjectContainer);

    DialogBuy.prototype.init = function(){
        this.width = 393;
        this.height = 232;
        this.alpha = 0;
    };

    DialogBuy.prototype.show = function(text,okAction,cancelAction){
    ...
    DialogBuy.prototype.getText = function(text){
        var px = 35;
        var py = 52;
        var w = 324;
        var h = 70;
    ...
    DialogBuy.prototype.getOK = function(callback){
        return this.getBtn(0,callback);
    };

    DialogBuy.prototype.getCancel = function(callback){
        return this.getBtn(1,callback);
    };

    DialogBuy.prototype.getBtn = function(id,callback){
        var width = 149;
        var height = 42;
        var margin = 1;
    ...
    DialogBuy.prototype.getBg = function(){
